...
public class Activity {
    ...
    public static final int LOGIN_SUCCESS_PARTNER = 14;
    public static final int LOGIN_FAILED_USER_NOT_FOUND_PARTNER = 15;
    public static final int LOGIN_FAILED_WRONG_PASSWORD_PARTNER = 16;    
    
    public static final int LOGIN_SUCCESS_CUSTOMER = 17;
    public static final int LOGIN_FAILED_USER_NOT_FOUND_CUSTOMER = 18;
    public static final int LOGIN_FAILED_WRONG_PASSWORD_CUSTOMER = 19;
